...
export default function ThemeToggle() {
  ...
  const handleToggle = () => {
    ...
    console.log("Switching theme to:", newTheme); // Debugging
  ...
  return (
    <div>
      <button
        ...
        className="flex items-center justify-center w-8 h-8 bg-slate-100 hover:bg-slate-200 
          dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full focus:outline-none"
      >
        {currentTheme === "light" ? (
          <svg className="w-4 h-4" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
            <path
